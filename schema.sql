...
--
-- Hôte : mariadb:3306
-- Généré le : jeu. 08 août 2024 à 09:33
...
--
CREATE DATABASE IF NOT EXISTS `demo` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci;
USE demo;
...
--
-- Structure de la table `InvoiceLine`
--
...
--
-- Déchargement des données de la table `InvoiceLine`
--
...
--
-- Déchargement des données de la table `PlaylistTrack`
--
...
--
-- Index pour la table `InvoiceLine`
--
ALTER TABLE `InvoiceLine`
  ADD PRIMARY KEY (`InvoiceLineId`),
  ADD KEY `FK_InvoiceLineInvoiceId` (`InvoiceId`),
...
ALTER TABLE `Track`
  ...
  ADD KEY `FK_TrackAlbumId` (`AlbumId`),
  ADD KEY `FK_TrackGenreId` (`GenreId`),
...
--
-- AUTO_INCREMENT pour la table `InvoiceLine`
--
ALTER TABLE `InvoiceLine`
...
--
-- Contraintes pour la table `InvoiceLine`
--
ALTER TABLE `InvoiceLine`
...
--
-- Base de données : `router`
--
CREATE DATABASE IF NOT EXISTS `router` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci;
USE router;

-- --------------------------------------------------------

--
-- Structure de la table `router_authority`
--

CREATE TABLE `router_authority` (
  `id` int(11) NOT NULL,
  `vo` varchar(128) BINARY NOT NULL DEFAULT 'ami',
  `clientDN` varchar(512) BINARY NOT NULL,
  `issuerDN` varchar(512) BINARY NOT NULL,
  `notBefore` date NOT NULL,
  `notAfter` date NOT NULL,
  `serial` varchar(128) BINARY NOT NULL,
  `email` varchar(128) BINARY NOT NULL,
  `reason` smallint(6) DEFAULT NULL,
  `created` timestamp NOT NULL DEFAULT current_timestamp(),
  `createdBy` varchar(128) BINARY NOT NULL,
  `modified` timestamp NOT NULL DEFAULT current_timestamp(),
  `modifiedBy` varchar(128) BINARY NOT NULL
) ;

-- --------------------------------------------------------

--
-- Structure de la table `router_catalog`
--

CREATE TABLE `router_catalog` (
  `id` int(11) NOT NULL,
  `externalCatalog` varchar(128) BINARY NOT NULL,
  `internalCatalog` varchar(128) BINARY NOT NULL,
  `internalSchema` varchar(128) BINARY DEFAULT NULL,
  `jdbcUrl` varchar(2048) BINARY NOT NULL,
  `user` varchar(128) BINARY NOT NULL,
  `pass` varchar(128) BINARY NOT NULL,
  `json` text DEFAULT NULL,
  `description` varchar(512) BINARY DEFAULT 'N/A',
...
--
-- Déchargement des données de la table `router_catalog`
--
...
(1, 'self', 'router', NULL, 'jdbc:mariadb://mariadb:3306/router?serverTimezone=UTC', 'ML1mV/bxsm0/bVLHJBBmKA==', 'ML1mV/bxsm0/bVLHJBBmKA==', '{\"router_authority\":{\"x\":260,\"y\":390,\"color\":\"#1494CC\"},\"router_catalog\":{\"x\":0,\"y\":0,\"color\":\"#2BBB88\"},\"router_command\":{\"x\":0,\"y\":390,\"color\":\"#0066CC\"},\"router_command_role\":{\"x\":0,\"y\":280,\"color\":\"#0066CC\"},\"router_config\":{\"x\":780,\"y\":250,\"color\":\"#FF0000\"},\"router_converter\":{\"x\":780,\"y\":420,\"color\":\"#FF0000\"},\"router_dashboard\":{\"x\":260,\"y\":690,\"color\":\"#CCCC33\"},\"router_entity\":{\"x\":260,\"y\":0,\"color\":\"#2BBB88\"},\"router_field\":{\"x\":520,\"y\":0,\"color\":\"#2BBB88\"},\"router_foreign_key\":{\"x\":780,\"y\":0,\"color\":\"#2BBB88\"},\"router_ipv4_blocks\":{\"x\":0,\"y\":910,\"color\":\"#CCAC81\"},\"router_ipv6_blocks\":{\"x\":0,\"y\":1050,\"color\":\"#CCAA88\"},\"router_locations\":{\"x\":290,\"y\":995,\"color\":\"#CCAA88\"},\"router_markdown\":{\"x\":780,\"y\":690,\"color\":\"#CCCC33\"},\"router_monitoring\":{\"x\":780,\"y\":530,\"color\":\"#FF0000\"},\"router_role\":{\"x\":260,\"y\":280,\"color\":\"#0066CC\"},\"router_search_interface\":{\"x\":520,\"y\":690,\"color\":\"#CCCC33\"},\"router_session\":{\"x\":1040,\"y\":0,\"color\":\"#009192\"},\"router_short_url\":{\"x\":0,\"y\":690,\"color\":\"#CCCC33\"},\"router_user\":{\"x\":520,\"y\":390,\"color\":\"#0066CC\"},\"router_user_role\":{\"x\":520,\"y\":280,\"color\":\"#0066CC\"}}', 'AMI configuration catalog', 0, '2022-05-17 12:32:28', 'admin', '2024-08-08 09:19:24', 'admin'),
(2, 'task', 'task', NULL, 'jdbc:mariadb://mariadb:3306/task?serverTimezone=UTC', 'ML1mV/bxsm0/bVLHJBBmKA==', 'ML1mV/bxsm0/bVLHJBBmKA==', '{\"router_task\":{\"x\":260,\"y\":10,\"color\":\"#0066CC\"},\"router_task_server\":{\"x\":10,\"y\":10,\"color\":\"#0066CC\"}}', 'AMI tasks catalog', 0, '2022-05-17 12:33:44', 'admin', '2024-08-08 09:29:16', 'admin'),
(3, 'demo', 'demo', NULL, 'jdbc:mariadb://mariadb:3306/demo?serverTimezone=UTC', 'ML1mV/bxsm0/bVLHJBBmKA==', 'ML1mV/bxsm0/bVLHJBBmKA==', '{\"album\":{\"x\":560,\"y\":395,\"color\":\"#ff9300\"},\"artist\":{\"x\":560,\"y\":290,\"color\":\"#ff9300\"},\"customer\":{\"x\":700,\"y\":15,\"color\":\"#5e5e5e\"},\"employee\":{\"x\":970,\"y\":0,\"color\":\"#5e5e5e\"},\"genre\":{\"x\":10,\"y\":220,\"color\":\"#0066CC\"},\"invoice\":{\"x\":700,\"y\":520,\"color\":\"#941651\"},\"invoiceline\":{\"x\":290,\"y\":550,\"color\":\"#941651\"},\"mediatype\":{\"x\":10,\"y\":400,\"color\":\"#9437ff\"},\"playlist\":{\"x\":290,\"y\":150,\"color\":\"#008f51\"},\"playlisttrack\":{\"x\":290,\"y\":250,\"color\":\"#0066CC\"},\"preference\":{\"x\":10,\"y\":90,\"color\":\"#0066CC\"},\"track\":{\"x\":290,\"y\":350,\"color\":\"#0066CC\"}}', 'AMI demo catalog', 0, '2022-05-17 12:34:05', 'admin', '2024-08-08 09:29:47', 'admin');

-- --------------------------------------------------------

--
-- Structure de la table `router_command`
--

CREATE TABLE `router_command` (
  `id` int(11) NOT NULL,
  `command` varchar(128) BINARY NOT NULL,
  `class` varchar(256) BINARY NOT NULL,
  `visible` tinyint(1) NOT NULL DEFAULT 1,
  `secured` tinyint(1) NOT NULL DEFAULT 0,
  `roleValidatorClass` varchar(256) BINARY DEFAULT NULL
) ;

--
-- Déchargement des données de la table `router_command`
--

INSERT INTO `router_command` (`id`, `command`, `class`, `visible`, `secured`, `roleValidatorClass`) VALUES
(1, 'SetJSONSchema', 'net.hep.ami.command.catalog.SetJSONSchema', 0, 0, NULL),
(3, 'PingNode', 'net.hep.ami.command.server.PingNode', 0, 0, NULL),
(5, 'GetUserInfo', 'net.hep.ami.command.user.GetUserInfo', 1, 0, NULL),
(6, 'GetCatalogInfo', 'net.hep.ami.command.catalog.GetCatalogInfo', 1, 0, NULL),
(7, 'GetSchemas', 'net.hep.ami.command.catalog.GetSchemas', 1, 0, NULL),
(8, 'ListRoles', 'net.hep.ami.command.admin.ListRoles', 1, 0, NULL),
(9, 'ListUsers', 'net.hep.ami.command.user.ListUsers', 1, 0, NULL),
(10, 'AddUpdateElement', 'net.hep.ami.command.catalog.AddUpdateElement', 1, 0, NULL),
(11, 'ChangePassword', 'net.hep.ami.command.user.ChangePassword', 1, 0, NULL),
(12, 'UpdateElements', 'net.hep.ami.command.catalog.UpdateElements', 1, 0, NULL),
(13, 'ListDrivers', 'net.hep.ami.command.catalog.ListDrivers', 1, 0, NULL),
...
(21, 'ListCatalogs', 'net.hep.ami.command.catalog.ListCatalogs', 1, 0, NULL),
(22, 'FindNewCommands', 'net.hep.ami.command.admin.FindNewCommands', 0, 0, NULL),
(24, 'GetEntityInfo', 'net.hep.ami.command.catalog.GetEntityInfo', 1, 0, NULL),
(25, 'ListFields', 'net.hep.ami.command.catalog.ListFields', 1, 0, NULL),
(26, 'RemoveCommandRole', 'net.hep.ami.command.admin.RemoveCommandRole', 0, 0, NULL),
...
(34, 'GenerateCertificate', 'net.hep.ami.command.certificate.GenerateCertificate', 0, 1, NULL),
(35, 'ResetPassword', 'net.hep.ami.command.user.ResetPassword', 1, 0, NULL),
(36, 'Encrypt', 'net.hep.ami.command.admin.Encrypt', 0, 1, NULL),
(38, 'RemoveElements', 'net.hep.ami.command.catalog.RemoveElements', 1, 0, NULL),
(39, 'FlushCommandCache', 'net.hep.ami.command.server.FlushCommandCache', 1, 0, NULL),
(40, 'GenerateCaptcha', 'net.hep.ami.command.user.GenerateCaptcha', 0, 0, NULL),
(41, 'SearchQuery', 'net.hep.ami.command.catalog.SearchQuery', 1, 0, NULL),
(42, 'AddUserRole', 'net.hep.ami.command.admin.AddUserRole', 0, 0, NULL),
(43, 'GetFieldInfo', 'net.hep.ami.command.catalog.GetFieldInfo', 1, 0, NULL),
(44, 'RemoveUser', 'net.hep.ami.command.user.RemoveUser', 0, 0, NULL),
(45, 'BrowseQuery', 'net.hep.ami.command.catalog.BrowseQuery', 1, 0, NULL),
(46, 'AddUser', 'net.hep.ami.command.user.AddUser', 0, 0, NULL),
(47, 'GenerateCertificateAndSendEmail', 'net.hep.ami.command.certificate.GenerateCertificateAndSendEmail', 0, 1, NULL),
...
(55, 'GetSessionInfo', 'net.hep.ami.command.user.GetSessionInfo', 1, 0, NULL),
(56, 'GetPageInfo', 'net.hep.ami.command.page.GetPageInfo', 1, 0, NULL),
(57, 'Decrypt', 'net.hep.ami.command.admin.Decrypt', 0, 1, NULL),
(59, 'ListInterfaces', 'net.hep.ami.command.catalog.ListInterfaces', 1, 0, NULL),
(60, 'SetConfigProperty', 'net.hep.ami.command.admin.SetConfigProperty', 0, 1, NULL),
(61, 'GenerateRevocationList', 'net.hep.ami.command.certificate.GenerateRevocationList', 0, 0, NULL),
(63, 'GetServerStatus', 'net.hep.ami.command.server.GetServerStatus', 0, 0, NULL),
(64, 'GetConfig', 'net.hep.ami.command.admin.GetConfig', 0, 1, NULL),
(65, 'ListConverters', 'net.hep.ami.command.admin.ListConverters', 1, 0, NULL),
(66, 'AddCommandRole', 'net.hep.ami.command.admin.AddCommandRole', 0, 0, NULL),
(68, 'ListEntities', 'net.hep.ami.command.catalog.ListEntities', 1, 0, NULL),
(69, 'RemoveCommand', 'net.hep.ami.command.admin.RemoveCommand', 0, 0, NULL),
(70, 'RemoveRole', 'net.hep.ami.command.admin.RemoveRole', 0, 0, NULL),
(71, 'ListRoleValidators', 'net.hep.ami.command.admin.ListRoleValidators', 1, 0, NULL),
(72, 'UpdateConfig', 'net.hep.ami.command.admin.UpdateConfig', 0, 1, NULL),
(73, 'GetJSONSchema', 'net.hep.ami.command.catalog.GetJSONSchema', 1, 0, NULL),
(74, 'AnalyzeQuery', 'net.hep.ami.command.catalog.AnalyzeQuery', 0, 0, NULL),
(76, 'RemoveConfigProperty', 'net.hep.ami.command.admin.RemoveConfigProperty', 0, 1, NULL),
(77, 'AddDashboard', 'net.hep.ami.command.hashable.dashboard.AddDashboard', 1, 0, NULL),
(78, 'UpdateDashboard', 'net.hep.ami.command.hashable.dashboard.UpdateDashboard', 1, 0, NULL),
(79, 'UpdateHash', 'net.hep.ami.command.hashable.hash.UpdateHash', 1, 0, NULL),
(80, 'RemoveHash', 'net.hep.ami.command.hashable.hash.RemoveHash', 1, 0, NULL),
(81, 'AddHash', 'net.hep.ami.command.hashable.hash.AddHash', 1, 0, NULL),
(82, 'BCrypt', 'net.hep.ami.command.admin.BCrypt', 0, 0, NULL),
(83, 'GetDashboardInfo', 'net.hep.ami.command.hashable.dashboard.GetDashboardInfo', 1, 0, NULL),
(84, 'ListDashboards', 'net.hep.ami.command.hashable.dashboard.ListDashboards', 1, 0, NULL),
(85, 'RemoveDashboardWidget', 'net.hep.ami.command.hashable.dashboard.RemoveDashboardWidget', 1, 0, NULL),
(86, 'Histogram', 'net.hep.ami.command.catalog.Histogram', 1, 0, NULL),
(87, 'UpdateDashboardWidget', 'net.hep.ami.command.hashable.dashboard.UpdateDashboardWidget', 1, 0, NULL),
(88, 'GetHashInfo', 'net.hep.ami.command.hashable.hash.GetHashInfo', 1, 0, NULL),
(89, 'AddDashboardWidget', 'net.hep.ami.command.hashable.dashboard.AddDashboardWidget', 1, 0, NULL),
(90, 'ListLogAppenders', 'net.hep.ami.command.admin.ListLogAppenders', 1, 0, NULL),
(91, 'GetTmpPassword', 'net.hep.ami.command.user.GetTmpPassword', 1, 0, NULL),
(92, 'RemoveDashboard', 'net.hep.ami.command.hashable.dashboard.RemoveDashboard', 1, 0, NULL),
(93, 'ListHashes', 'net.hep.ami.command.hashable.hash.ListHashes', 1, 0, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `router_command_role`
--
...
--
-- Déchargement des données de la table `router_command_role`
--

INSERT INTO `router_command_role` (`id`, `commandFK`, `roleFK`) VALUES
(1, 1, 1),
(3, 3, 7),
(5, 5, 6),
(6, 6, 6),
...
--
-- Structure de la table `router_config`
--

CREATE TABLE `router_config` (
  `id` int(11) NOT NULL,
  `paramName` varchar(128) BINARY NOT NULL,
  `paramValue` varchar(512) BINARY DEFAULT NULL,
  `created` timestamp NOT NULL DEFAULT current_timestamp(),
  `createdBy` varchar(128) BINARY NOT NULL,
  `modified` timestamp NOT NULL DEFAULT current_timestamp(),
  `modifiedBy` varchar(128) BINARY NOT NULL
...
--
-- Structure de la table `router_converter`
--

CREATE TABLE `router_converter` (
  `id` int(11) NOT NULL,
  `xslt` varchar(128) BINARY NOT NULL,
  `mime` varchar(128) BINARY NOT NULL
) ;

--
-- Déchargement des données de la table `router_converter`
--

INSERT INTO `router_converter` (`id`, `xslt`, `mime`) VALUES
(1, '/xslt/AMIXmlToText.xsl', 'text/plain'),
(2, '/xslt/AMIXmlToCsv.xsl', 'text/csv'),
(3, '/xslt/AMIXmlToJson.xsl', 'application/json'),
(4, '/xslt/AMIXmlToXml.xsl', 'application/xml');

-- --------------------------------------------------------

--
-- Structure de la table `router_dashboard`
--
...
CREATE TABLE `router_dashboard` (
  ...
  `archived` tinyint(1) NOT NULL DEFAULT 0,
  `owner` varchar(128) BINARY NOT NULL,
  `created` timestamp NOT NULL DEFAULT current_timestamp(),
  `modified` timestamp NOT NULL DEFAULT current_timestamp()
) ;

--
-- Déchargement des données de la table `router_dashboard`
--

INSERT INTO `router_dashboard` (`id`, `hash`, `name`, `rank`, `json`, `shared`, `archived`, `owner`, `created`, `modified`) VALUES
(1, 'MzQ3NjQ5', 'Alanis', 0, '{\"OTExMTk4\":{\"id\":\"OTExMTk4\",\"control\":\"Table\",\"params\":[\"BrowseQuery -GUI -catalog=\\\"demo\\\" -entity=\\\"Track\\\" -mql=\\\"SELECT * WHERE [`demo`.`Artist`.`Name` = \\\\\'Alanis MORissette\\\\\']\\\"\"],\"options\":{\"customLabelsFragment\":null,\"customInputsFragment\":null,\"customHTMLsFragment\":null,\"enableCache\":false,\"enableCount\":true,\"enableEditMode\":false,\"hideBigContent\":true,\"showPrimaryField\":true,\"showToolBar\":true,\"showDetails\":true,\"showTools\":true,\"canEdit\":false,\"catalog\":\"demo\",\"entity\":\"Track\",\"primaryField\":\"TrackId\",\"rowset\":\"\",\"start\":1,\"stop\":10,\"orderBy\":\"\",\"orderWay\":\"\",\"maxCellLength\":64,\"card\":true},\"transparent\":false,\"autoRefresh\":true,\"x\":0,\"y\":0,\"width\":12,\"height\":22}}', 0, 0, 'admin', '2024-08-08 09:30:59', '2024-08-08 09:31:21');

-- --------------------------------------------------------

--
-- Structure de la table `router_entity`
--

CREATE TABLE `router_entity` (
  `id` int(11) NOT NULL,
  `catalog` varchar(128) BINARY NOT NULL,
  `entity` varchar(128) BINARY NOT NULL,
...
--
-- Déchargement des données de la table `router_entity`
--

INSERT INTO `router_entity` (`id`, `catalog`, `entity`, `rank`, `json`, `description`, `created`, `createdBy`, `modified`, `modifiedBy`) VALUES
(1, 'demo', 'PlaylistTrack', 1009, '{\"bridge\":true,\"hidden\":false,\"adminOnly\":false}', 'N/A', '2022-05-02 14:43:07', 'admin', '2022-05-02 14:43:07', 'admin');

-- --------------------------------------------------------

--
-- Structure de la table `router_field`
--
...
CREATE TABLE `router_field` (
  ...
  `catalog` varchar(128) BINARY NOT NULL,
  `entity` varchar(128) BINARY NOT NULL,
  `field` varchar(128) BINARY NOT NULL,
  `rank` int(11) DEFAULT NULL,
  `json` text DEFAULT NULL,
  `description` varchar(512) BINARY DEFAULT 'N/A',
  `created` timestamp NOT NULL DEFAULT current_timestamp(),
...
--
-- Déchargement des données de la table `router_field`
--

INSERT INTO `router_field` (`id`, `catalog`, `entity`, `field`, `rank`, `json`, `description`, `created`, `createdBy`, `modified`, `modifiedBy`) VALUES
(1, 'demo', 'Playlist', 'PlaylistId', 1000, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":true,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 14:43:53', 'admin', '2022-05-02 14:43:53', 'admin'),
(2, 'demo', 'MediaType', 'MediaTypeId', 1000, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":true,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 14:44:09', 'admin', '2022-05-02 14:44:09', 'admin'),
(3, 'demo', 'Genre', 'GenreId', 1000, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":true,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 14:44:17', 'admin', '2022-05-02 14:44:17', 'admin'),
(4, 'demo', 'Artist', 'ArtistId', 1000, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":true,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 14:45:02', 'admin', '2022-05-02 14:45:02', 'admin'),
(5, 'demo', 'Album', 'AlbumId', 1000, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":true,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 14:54:49', 'admin', '2022-05-02 14:54:49', 'admin'),
(7, 'demo', 'Album', 'ArtistId', 1002, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 15:03:13', 'admin', '2022-05-02 15:03:13', 'admin'),
(11, 'demo', 'Track', 'MediaTypeId', 1003, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 15:46:06', 'admin', '2022-05-02 15:46:06', 'admin'),
(12, 'demo', 'Track', 'GenreId', 1004, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 15:46:15', 'admin', '2022-05-02 15:46:15', 'admin'),
(13, 'demo', 'Track', 'TrackId', 1000, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":true,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 15:49:07', 'admin', '2022-05-02 15:49:07', 'admin'),
(15, 'demo', 'Track', 'AlbumId', 1002, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 15:51:53', 'admin', '2022-05-02 15:51:53', 'admin'),
(19, 'demo', 'Album', 'Title', 1001, '{\"hidden\":false,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":false,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":\"import net.hep.ami.data.WebLink;\\n\\nwebLink = new WebLink();\\n\\nif(rowSet.isANameOrLabel(\\\"ArtistId\\\"))\\n{\\n\\twebLink.newLinkProperties().setLabel(\\\"Tracks\\\").setCtrl(\\\"table\\\").setLocation(WebLink.Location.CONTAINER).setParams(\\\"[\\\\\\\"BrowseQuery -catalog=\\\\\\\\\\\\\\\"demo\\\\\\\\\\\\\\\" -entity=\\\\\\\\\\\\\\\"Track\\\\\\\\\\\\\\\" -mql=\\\\\\\\\\\\\\\"SELECT * WHERE Artist.ArtistId=\'\\\" + row.getValue(\\\"ArtistId\\\") + \\\"\'\\\\\\\\\\\\\\\"\\\\\\\"]\\\").setSettings(\\\"{\\\\\\\"catalog\\\\\\\":\\\\\\\"demo\\\\\\\", \\\\\\\"entity\\\\\\\":\\\\\\\"Track\\\\\\\"}\\\").setIcon(\\\"table\\\").setTitle(\\\"Tracks\\\");\\n\\n\\twebLink.newLinkProperties().setLabel(\\\"Artists\\\").setCtrl(\\\"table\\\").setLocation(WebLink.Location.CONTAINER).setParams(\\\"[\\\\\\\"BrowseQuery -catalog=\\\\\\\\\\\\\\\"demo\\\\\\\\\\\\\\\" -entity=\\\\\\\\\\\\\\\"Artist\\\\\\\\\\\\\\\" -mql=\\\\\\\\\\\\\\\"SELECT * WHERE Artist.ArtistId=\'\\\" + row.getValue(\\\"ArtistId\\\") + \\\"\'\\\\\\\\\\\\\\\"\\\\\\\"]\\\").setSettings(\\\"{\\\\\\\"catalog\\\\\\\":\\\\\\\"demo\\\\\\\", \\\\\\\"entity\\\\\\\":\\\\\\\"Artists\\\\\\\"}\\\").setIcon(\\\"table\\\").setTitle(\\\"Artists\\\");\\n}\\n\\nreturn webLink;\\n\",\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 15:54:52', 'admin', '2022-05-02 15:54:52', 'admin'),
(20, 'demo', 'Track', 'Name', 1001, '{\"hidden\":false,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":false,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":\"import net.hep.ami.data.WebLink;\\n\\nwebLink = new WebLink();\\n\\nif(rowSet.isANameOrLabel(\\\"TrackId\\\"))\\n{\\n\\twebLink.newLinkProperties().setLabel(\\\"Artists\\\").setCtrl(\\\"table\\\").setLocation(WebLink.Location.CONTAINER).setParams(\\\"[\\\\\\\"BrowseQuery -catalog=\\\\\\\\\\\\\\\"demo\\\\\\\\\\\\\\\" -entity=\\\\\\\\\\\\\\\"Artist\\\\\\\\\\\\\\\" -mql=\\\\\\\\\\\\\\\"SELECT * WHERE Track.TrackId=\'\\\" + row.getValue(\\\"TrackId\\\") + \\\"\'\\\\\\\\\\\\\\\"\\\\\\\"]\\\").setSettings(\\\"{\\\\\\\"catalog\\\\\\\":\\\\\\\"demo\\\\\\\", \\\\\\\"entity\\\\\\\":\\\\\\\"Artist\\\\\\\"}\\\").setIcon(\\\"table\\\").setTitle(\\\"Artists\\\");\\n\\n\\twebLink.newLinkProperties().setLabel(\\\"Genre\\\").setCtrl(\\\"table\\\").setLocation(WebLink.Location.CONTAINER).setParams(\\\"[\\\\\\\"BrowseQuery -catalog=\\\\\\\\\\\\\\\"demo\\\\\\\\\\\\\\\" -entity=\\\\\\\\\\\\\\\"Genre\\\\\\\\\\\\\\\" -mql=\\\\\\\\\\\\\\\"SELECT * WHERE Track.TrackId=\'\\\" + row.getValue(\\\"TrackId\\\") + \\\"\'\\\\\\\\\\\\\\\"\\\\\\\"]\\\").setSettings(\\\"{\\\\\\\"catalog\\\\\\\":\\\\\\\"demo\\\\\\\", \\\\\\\"entity\\\\\\\":\\\\\\\"Genre\\\\\\\"}\\\").setIcon(\\\"table\\\").setTitle(\\\"Genre\\\");\\n\\n\\twebLink.newLinkProperties().setLabel(\\\"Playlists\\\").setCtrl(\\\"table\\\").setLocation(WebLink.Location.CONTAINER).setParams(\\\"[\\\\\\\"BrowseQuery -catalog=\\\\\\\\\\\\\\\"demo\\\\\\\\\\\\\\\" -entity=\\\\\\\\\\\\\\\"Playlist\\\\\\\\\\\\\\\" -mql=\\\\\\\\\\\\\\\"SELECT * WHERE Track.TrackId=\'\\\" + row.getValue(\\\"TrackId\\\") + \\\"\'\\\\\\\\\\\\\\\"\\\\\\\"]\\\").setSettings(\\\"{\\\\\\\"catalog\\\\\\\":\\\\\\\"demo\\\\\\\", \\\\\\\"entity\\\\\\\":\\\\\\\"Playlist\\\\\\\"}\\\").setIcon(\\\"table\\\").setTitle(\\\"Playlists\\\");\\n\\n\\twebLink.newLinkProperties().setLabel(\\\"Media Type\\\").setCtrl(\\\"table\\\").setLocation(WebLink.Location.CONTAINER).setParams(\\\"[\\\\\\\"BrowseQuery -catalog=\\\\\\\\\\\\\\\"demo\\\\\\\\\\\\\\\" -entity=\\\\\\\\\\\\\\\"MediaType\\\\\\\\\\\\\\\" -mql=\\\\\\\\\\\\\\\"SELECT * WHERE Track.TrackId=\'\\\" + row.getValue(\\\"TrackId\\\") + \\\"\'\\\\\\\\\\\\\\\"\\\\\\\"]\\\").setSettings(\\\"{\\\\\\\"catalog\\\\\\\":\\\\\\\"demo\\\\\\\", \\\\\\\"entity\\\\\\\":\\\\\\\"MediaType\\\\\\\"}\\\").setIcon(\\\"table\\\").setTitle(\\\"Media Type\\\");\\n}\\n\\nreturn webLink;\\n\",\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 15:55:27', 'admin', '2022-05-02 15:55:27', 'admin'),
(24, 'demo', 'Track', 'Bytes', 1007, '{\"hidden\":false,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":\"import net.hep.ami.data.WebLink;\\n\\nwebLink = new WebLink().setUnitName(\\\"Byte\\\").setUnitFactor(\\\"\\\").setUnitBase(\\\"1024\\\").setHumanReadable(\\\"true\\\");\\n\\nreturn webLink;\",\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 16:04:27', 'admin', '2022-05-02 16:04:27', 'admin'),
(25, 'demo', 'Invoice', 'CustomerId', 1001, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 17:10:30', 'admin', '2022-05-02 17:10:30', 'admin'),
(26, 'demo', 'InvoiceLine', 'InvoiceId', 1001, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 17:10:46', 'admin', '2022-05-02 17:10:46', 'admin'),
(27, 'demo', 'InvoiceLine', 'InvoiceLineId', 1000, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":true,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 17:11:03', 'admin', '2022-05-02 17:11:03', 'admin'),
(28, 'demo', 'InvoiceLine', 'TrackId', 1002, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-02 17:11:30', 'admin', '2022-05-02 17:11:30', 'admin'),
(29, 'demo', 'Invoice', 'InvoiceId', 1000, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":true,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-03 09:11:09', 'admin', '2022-05-03 09:11:09', 'admin'),
(30, 'demo', 'Customer', 'CustomerId', 1000, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":true,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-03 09:11:16', 'admin', '2022-05-03 09:11:16', 'admin'),
(31, 'demo', 'Employee', 'EmployeeId', 1000, '{\"hidden\":true,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":true,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":null,\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-03 09:11:23', 'admin', '2022-05-03 09:11:23', 'admin'),
(33, 'demo', 'Track', 'Milliseconds', 1006, '{\"hidden\":false,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":\"import net.hep.ami.data.WebLink;\\n\\nwebLink = new WebLink().setUnitName(\\\"s\\\").setUnitFactor(\\\"m\\\").setUnitBase(\\\"1000\\\").setHumanReadable(\\\"true\\\");\\n\\nreturn webLink;\",\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-03 14:46:48', 'admin', '2022-05-03 14:46:48', 'admin'),
(36, 'demo', 'track', 'Name', 1001, '{\"hidden\":false,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":false,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":\"import net.hep.ami.data.WebLink;\\n\\nwebLink = new WebLink();\\n\\nif(rowSet.isANameOrLabel(\\\"TrackId\\\"))\\n{\\n\\twebLink.newLinkProperties().setLabel(\\\"Artists\\\").setCtrl(\\\"table\\\").setLocation(WebLink.Location.CONTAINER).setParams(\\\"[\\\\\\\"BrowseQuery -catalog=\\\\\\\\\\\\\\\"demo\\\\\\\\\\\\\\\" -entity=\\\\\\\\\\\\\\\"Artist\\\\\\\\\\\\\\\" -mql=\\\\\\\\\\\\\\\"SELECT * WHERE Track.TrackId=\'\\\" + row.getValue(\\\"TrackId\\\") + \\\"\'\\\\\\\\\\\\\\\"\\\\\\\"]\\\").setSettings(\\\"{\\\\\\\"catalog\\\\\\\":\\\\\\\"demo\\\\\\\", \\\\\\\"entity\\\\\\\":\\\\\\\"Artist\\\\\\\"}\\\").setIcon(\\\"table\\\").setTitle(\\\"Artists\\\");\\n\\n\\twebLink.newLinkProperties().setLabel(\\\"Genre\\\").setCtrl(\\\"table\\\").setLocation(WebLink.Location.CONTAINER).setParams(\\\"[\\\\\\\"BrowseQuery -catalog=\\\\\\\\\\\\\\\"demo\\\\\\\\\\\\\\\" -entity=\\\\\\\\\\\\\\\"Genre\\\\\\\\\\\\\\\" -mql=\\\\\\\\\\\\\\\"SELECT * WHERE Track.TrackId=\'\\\" + row.getValue(\\\"TrackId\\\") + \\\"\'\\\\\\\\\\\\\\\"\\\\\\\"]\\\").setSettings(\\\"{\\\\\\\"catalog\\\\\\\":\\\\\\\"demo\\\\\\\", \\\\\\\"entity\\\\\\\":\\\\\\\"Genre\\\\\\\"}\\\").setIcon(\\\"table\\\").setTitle(\\\"Genre\\\");\\n\\n\\twebLink.newLinkProperties().setLabel(\\\"Playlists\\\").setCtrl(\\\"table\\\").setLocation(WebLink.Location.CONTAINER).setParams(\\\"[\\\\\\\"BrowseQuery -catalog=\\\\\\\\\\\\\\\"demo\\\\\\\\\\\\\\\" -entity=\\\\\\\\\\\\\\\"Playlist\\\\\\\\\\\\\\\" -mql=\\\\\\\\\\\\\\\"SELECT * WHERE Track.TrackId=\'\\\" + row.getValue(\\\"TrackId\\\") + \\\"\'\\\\\\\\\\\\\\\"\\\\\\\"]\\\").setSettings(\\\"{\\\\\\\"catalog\\\\\\\":\\\\\\\"demo\\\\\\\", \\\\\\\"entity\\\\\\\":\\\\\\\"Playlist\\\\\\\"}\\\").setIcon(\\\"table\\\").setTitle(\\\"Playlists\\\");\\n\\n\\twebLink.newLinkProperties().setLabel(\\\"Media Type\\\").setCtrl(\\\"table\\\").setLocation(WebLink.Location.CONTAINER).setParams(\\\"[\\\\\\\"BrowseQuery -catalog=\\\\\\\\\\\\\\\"demo\\\\\\\\\\\\\\\" -entity=\\\\\\\\\\\\\\\"MediaType\\\\\\\\\\\\\\\" -mql=\\\\\\\\\\\\\\\"SELECT * WHERE Track.TrackId=\'\\\" + row.getValue(\\\"TrackId\\\") + \\\"\'\\\\\\\\\\\\\\\"\\\\\\\"]\\\").setSettings(\\\"{\\\\\\\"catalog\\\\\\\":\\\\\\\"demo\\\\\\\", \\\\\\\"entity\\\\\\\":\\\\\\\"MediaType\\\\\\\"}\\\").setIcon(\\\"table\\\").setTitle(\\\"Media Type\\\");\\n}\\n\\nreturn webLink;\\n\",\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2022-05-17 22:57:37', 'admin', '2022-05-17 22:57:37', 'admin'),
(37, 'demo', 'Track', 'UnitPrice', 1008, '{\"hidden\":false,\"adminOnly\":false,\"hashed\":false,\"crypted\":false,\"primary\":false,\"json\":false,\"automatic\":false,\"created\":false,\"createdBy\":false,\"modified\":false,\"modifiedBy\":false,\"statable\":true,\"groupable\":false,\"displayQuery\":\"@NULL\",\"webLinkScript\":\"import net.hep.ami.data.WebLink;\\n\\n webLink = new WebLink();\\n\\n if(rowSet.isANameOrLabel(\\\"UnitPrice\\\"))\\n {\\n  if(Double.parseDouble(row.getValue(\\\"UnitPrice\\\")) >= 1)\\n  {\\n   webLink.setClass(\\\"badge badge-danger bg-danger w-100 d-block\\\");\\n  }\\n  else\\n  {\\n   webLink.setClass(\\\"badge badge-success bg-success w-100 d-block\\\");\\n  }\\n }\\n\\n return webLink;\",\"media\":false,\"base64\":false,\"mime\":null,\"ctrl\":null}', 'N/A', '2023-10-11 07:58:04', 'admin', '2023-10-11 07:58:04', 'admin');

-- --------------------------------------------------------

--
-- Structure de la table `router_foreign_key`
--

CREATE TABLE `router_foreign_key` (
  `id` int(11) NOT NULL,
  `name` varchar(128) BINARY NOT NULL,
  `fkCatalog` varchar(128) BINARY NOT NULL,
  `fkTable` varchar(128) BINARY NOT NULL,
  `fkColumn` varchar(128) BINARY NOT NULL,
  `pkCatalog` varchar(128) BINARY NOT NULL,
  `pkTable` varchar(128) BINARY NOT NULL,
  `pkColumn` varchar(128) BINARY NOT NULL,
  `created` timestamp NOT NULL DEFAULT current_timestamp(),
  `createdBy` varchar(128) BINARY NOT NULL,
  `modified` timestamp NOT NULL DEFAULT current_timestamp(),
  `modifiedBy` varchar(128) BINARY NOT NULL
...
--
-- Structure de la table `router_ipv4_blocks`
--

CREATE TABLE `router_ipv4_blocks` (
  `id` int(11) NOT NULL,
  `network` varchar(32) BINARY NOT NULL,
...
--
-- Structure de la table `router_ipv6_blocks`
--

CREATE TABLE `router_ipv6_blocks` (
  `id` int(11) NOT NULL,
  `network` varchar(64) BINARY NOT NULL,
...
--
-- Structure de la table `router_locations`
--

CREATE TABLE `router_locations` (
  `id` int(11) NOT NULL,
  `continentCode` varchar(3) BINARY NOT NULL DEFAULT 'N/A',
  `countryCode` varchar(3) BINARY NOT NULL DEFAULT 'N/A'
) ;

-- --------------------------------------------------------

--
-- Structure de la table `router_markdown`
--
...
--
-- Structure de la table `router_monitoring`
--

CREATE TABLE `router_monitoring` (
  `id` int(11) NOT NULL,
  `node` varchar(128) BINARY NOT NULL,
  `endpoint` varchar(512) BINARY NOT NULL,
  `service` varchar(128) BINARY NOT NULL,
  `frequency` int(11) DEFAULT 10,
  `modified` timestamp NOT NULL DEFAULT current_timestamp()
) ;
...
--
-- Structure de la table `router_role`
--
...
--
-- Déchargement des données de la table `router_role`
--

INSERT INTO `router_role` (`id`, `role`, `description`) VALUES
(1, 'AMI_ADMIN', 'N/A'),
(2, 'AMI_SUDOER', 'N/A'),
(3, 'AMI_SSO', 'N/A'),
(4, 'AMI_CERT', 'N/A'),
...
--
-- Structure de la table `router_search_interface`
--

CREATE TABLE `router_search_interface` (
  `id` int(11) NOT NULL,
  `group` varchar(128) BINARY NOT NULL,
  `name` varchar(128) BINARY NOT NULL,
  `rank` int(11) NOT NULL DEFAULT 0,
  `json` text NOT NULL,
  `archived` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Déchargement des données de la table `router_search_interface`
--

INSERT INTO `router_search_interface` (`id`, `group`, `name`, `rank`, `json`, `archived`, `created`, `createdBy`, `modified`, `modifiedBy`) VALUES
(1, 'Store', 'Employee', 3, '{\"defaultCatalog\":\"demo\",\"defaultEntity\":\"Employee\",\"defaultPrimaryField\":\"EmployeeId\",\"more\":{},\"criteria\":[{\"name\":\"Employee LastName\",\"catalog\":\"demo\",\"entity\":\"Employee\",\"field\":\"LastName\",\"type\":0,\"more\":{\"auto_open\":true,\"simple_search\":true}},{\"name\":\"Employee FirstName\",\"catalog\":\"demo\",\"entity\":\"Employee\",\"field\":\"FirstName\",\"type\":1,\"more\":{\"simple_search\":true}},{\"name\":\"Customer FirstName\",\"catalog\":\"demo\",\"entity\":\"Customer\",\"field\":\"FirstName\",\"type\":1,\"more\":{}},{\"name\":\"Customer LastName\",\"catalog\":\"demo\",\"entity\":\"Customer\",\"field\":\"LastName\",\"type\":1,\"more\":{}},{\"name\":\"Invoice Total\",\"catalog\":\"demo\",\"entity\":\"Invoice\",\"field\":\"Total\",\"type\":2,\"more\":{\"auto_open\":false,\"simple_search\":false,\"constraints\":[\"!`demo`.`Preference`.`CustomerId`\"]}}]}', 0, '2022-05-03 09:06:14', 'admin', '2022-05-20 14:18:25', 'admin'),
(2, 'Store', 'Customer', 2, '{\"defaultCatalog\":\"demo\",\"defaultEntity\":\"Customer\",\"defaultPrimaryField\":\"CustomerId\",\"more\":{},\"criteria\":[{\"name\":\"Customer Last Name\",\"catalog\":\"demo\",\"entity\":\"Customer\",\"field\":\"LastName\",\"type\":1,\"more\":{\"auto_open\":true,\"simple_search\":true}},{\"name\":\"Customer First Name\",\"catalog\":\"demo\",\"entity\":\"Customer\",\"field\":\"FirstName\",\"type\":1,\"more\":{\"simple_search\":true}},{\"name\":\"Single\",\"catalog\":\"demo\",\"entity\":\"Track\",\"field\":\"Name\",\"type\":1,\"more\":{\"auto_open\":false,\"simple_search\":true,\"constraints\":[\"`demo`.`Invoice`.`CustomerId`\"]}},{\"name\":\"Invoice Total\",\"catalog\":\"demo\",\"entity\":\"Invoice\",\"field\":\"Total\",\"type\":2,\"more\":{\"auto_open\":false,\"simple_search\":false,\"constraints\":[\"!`demo`.`Preference`.`CustomerId`\"]}},{\"name\":\"Favorite Genres\",\"catalog\":\"demo\",\"entity\":\"Genre\",\"field\":\"Name\",\"type\":0,\"more\":{\"auto_open\":false,\"simple_search\":false,\"constraints\":[\"`demo`.`Preference`.`CustomerId`\"]}},{\"name\":\"Purchased Genres\",\"catalog\":\"demo\",\"entity\":\"Genre\",\"field\":\"Name\",\"type\":0,\"more\":{\"auto_open\":false,\"simple_search\":false,\"constraints\":[\"`demo`.`Invoice`.`CustomerId`\"]}}]}', 0, '2022-05-03 09:06:18', 'admin', '2022-05-20 14:17:49', 'admin'),
(3, 'Music', 'Artist', 1, '{\"defaultCatalog\":\"demo\",\"defaultEntity\":\"Artist\",\"defaultPrimaryField\":\"ArtistId\",\"more\":{},\"criteria\":[{\"name\":\"Artist\",\"catalog\":\"demo\",\"entity\":\"Artist\",\"field\":\"Name\",\"type\":1,\"more\":{\"auto_open\":true,\"simple_search\":true}},{\"name\":\"Single\",\"catalog\":\"demo\",\"entity\":\"Track\",\"field\":\"Name\",\"type\":1,\"more\":{\"simple_search\":true}},{\"name\":\"Genre\",\"catalog\":\"demo\",\"entity\":\"Genre\",\"field\":\"Name\",\"type\":0,\"more\":{\"auto_open\":false,\"simple_search\":false,\"constraints\":[\"!`demo`.`InvoiceLine`.`InvoiceId`\"]}},{\"name\":\"Customer LastName\",\"catalog\":\"demo\",\"entity\":\"Customer\",\"field\":\"LastName\",\"type\":0,\"more\":{\"auto_open\":false,\"simple_search\":false,\"constraints\":[\"`demo`.`InvoiceLine`.`TrackId`\"]}}]}', 0, '2022-05-03 09:06:28', 'admin', '2022-05-20 13:31:18', 'admin'),
(4, 'Music', 'Track', 0, '{\"defaultCatalog\":\"demo\",\"defaultEntity\":\"Track\",\"defaultPrimaryField\":\"TrackId\",\"more\":{},\"criteria\":[{\"name\":\"Title\",\"catalog\":\"demo\",\"entity\":\"Track\",\"field\":\"Name\",\"type\":1,\"more\":{\"auto_open\":true,\"simple_search\":true}},{\"name\":\"Milliseconds\",\"catalog\":\"demo\",\"entity\":\"Track\",\"field\":\"Milliseconds\",\"type\":2,\"more\":{}},{\"name\":\"Bytes\",\"catalog\":\"demo\",\"entity\":\"Track\",\"field\":\"Bytes\",\"type\":2,\"more\":{}},{\"name\":\"Genre\",\"catalog\":\"demo\",\"entity\":\"Genre\",\"field\":\"Name\",\"type\":0,\"more\":{\"auto_open\":false,\"simple_search\":false,\"constraints\":[\"!`demo`.`InvoiceLine`.`InvoiceId`\"]}},{\"name\":\"Artist\",\"catalog\":\"demo\",\"entity\":\"Artist\",\"field\":\"Name\",\"type\":1,\"more\":{\"simple_search\":true}},{\"name\":\"PlayList\",\"catalog\":\"demo\",\"entity\":\"Playlist\",\"field\":\"Name\",\"type\":0,\"more\":{}},{\"name\":\"Media\",\"catalog\":\"demo\",\"entity\":\"MediaType\",\"field\":\"Name\",\"type\":0,\"more\":{}}]}', 0, '2022-05-03 09:08:07', 'admin', '2022-05-20 13:05:21', 'admin');

-- --------------------------------------------------------

--
-- Structure de la table `router_short_url`
--
...
--
-- Déchargement des données de la table `router_short_url`
--

INSERT INTO `router_short_url` (`id`, `hash`, `name`, `rank`, `json`, `shared`, `expire`, `owner`, `created`, `modified`) VALUES
(2, 'NjUzNzcx', 'AC/DC', 0, '{\n  \"subapp\": \"TableViewer\",\n  \"userdata\": \"{\\\"command\\\":\\\"BrowseQuery -GUI -catalog=\\\\\\\"demo\\\\\\\" -entity=\\\\\\\"Track\\\\\\\" -mql=\\\\\\\"SELECT * WHERE [`demo`.`Artist`.`Name` = \\\\\\\\\'AC/DC\\\\\\\\\']\\\\\\\" -limit=\\\\\\\"10\\\\\\\" -offset=\\\\\\\"0\\\\\\\"\\\",\\\"catalog\\\":\\\"demo\\\",\\\"entity\\\":\\\"Track\\\",\\\"primaryField\\\":\\\"TrackId\\\",\\\"rowset\\\":\\\"\\\",\\\"start\\\":1,\\\"stop\\\":10,\\\"orderBy\\\":\\\"\\\",\\\"orderWay\\\":\\\"\\\",\\\"maxCellLength\\\":64}\"\n}', 1, 0, 'admin', '2024-08-08 09:32:13', '2024-08-08 09:32:13');

-- --------------------------------------------------------

--
-- Structure de la table `router_user`
--

CREATE TABLE `router_user` (
  `id` int(11) NOT NULL,
  `AMIUser` varchar(128) BINARY NOT NULL,
  `ssoUser` varchar(128) BINARY DEFAULT NULL,
  `AMIPass` varchar(128) BINARY NOT NULL,
  `clientDN` varchar(512) BINARY DEFAULT NULL,
  `issuerDN` varchar(512) BINARY DEFAULT NULL,
  `firstName` varchar(128) BINARY NOT NULL,
  `lastName` varchar(128) BINARY NOT NULL,
  `email` varchar(128) BINARY NOT NULL,
  `country` varchar(128) BINARY DEFAULT 'N/A',
  `json` text DEFAULT NULL,
...
--
-- Déchargement des données de la table `router_user`
--

INSERT INTO `router_user` (`id`, `AMIUser`, `ssoUser`, `AMIPass`, `clientDN`, `issuerDN`, `firstName`, `lastName`, `email`, `country`, `json`, `valid`, `created`, `modified`) VALUES
(1, 'admin', NULL, '9k6JOHS6YnH3L3rLvFgiUQ==', NULL, NULL, 'admin', 'admin', 'ami@lpsc.in2p3.fr', 'N/A', NULL, 1, '2022-05-17 12:32:28', '2022-05-17 12:32:28'),
(2, 'sudoer', NULL, '9k6JOHS6YnH3L3rLvFgiUQ==', NULL, NULL, 'sudoer', 'sudoer', 'ami@lpsc.in2p3.fr', 'N/A', NULL, 1, '2022-05-17 12:32:28', '2022-05-17 12:32:28'),
(3, 'sso', NULL, '9k6JOHS6YnH3L3rLvFgiUQ==', NULL, NULL, 'sso', 'sso', 'ami@lpsc.in2p3.fr', 'N/A', NULL, 1, '2022-05-17 12:32:28', '2022-05-17 12:32:28'),
(4, 'guest', NULL, 'xOXuMwBt0wfv1jFHsZiYVw==', NULL, NULL, 'guest', 'guest', 'ami@lpsc.in2p3.fr', 'N/A', NULL, 1, '2022-05-17 12:32:28', '2022-05-17 12:32:28'),
(5, 'user', NULL, '9k6JOHS6YnH3L3rLvFgiUQ==', NULL, NULL, 'user', 'user', 'ami@lpsc.in2p3.fr', 'N/A', '{}', 1, '2023-10-11 07:01:28', '2023-10-11 07:03:47');

-- --------------------------------------------------------

--
-- Structure de la table `router_user_role`
--
...
--
-- Déchargement des données de la table `router_user_role`
--

INSERT INTO `router_user_role` (`id`, `userFK`, `roleFK`) VALUES
(1, 1, 1),
(3, 2, 2),
(2, 2, 6),
(4, 3, 3),
...
--
-- Index pour la table `router_authority`
--
ALTER TABLE `router_authority`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_authority` (`serial`);

--
-- Index pour la table `router_catalog`
--
ALTER TABLE `router_catalog`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_catalog` (`externalCatalog`);

--
-- Index pour la table `router_command`
--
ALTER TABLE `router_command`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_command` (`command`);

--
-- Index pour la table `router_command_role`
--
ALTER TABLE `router_command_role`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_command_role` (`commandFK`,`roleFK`),
  ADD KEY `fk2_router_command_role` (`roleFK`);

--
-- Index pour la table `router_config`
--
ALTER TABLE `router_config`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_config` (`paramName`);

--
-- Index pour la table `router_converter`
--
ALTER TABLE `router_converter`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_converter` (`xslt`);

--
-- Index pour la table `router_dashboard`
--
ALTER TABLE `router_dashboard`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `router_entity`
--
ALTER TABLE `router_entity`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_entity` (`catalog`(64),`entity`(64));

--
-- Index pour la table `router_field`
--
ALTER TABLE `router_field`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_field` (`catalog`(64),`entity`(64),`field`);

--
-- Index pour la table `router_foreign_key`
--
ALTER TABLE `router_foreign_key`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_frgn_key` (`name`),
  ADD UNIQUE KEY `uk2_router_frgn_key` (`fkCatalog`,`fkTable`,`fkColumn`,`pkCatalog`,`pkTable`,`pkColumn`);

--
-- Index pour la table `router_ipv4_blocks`
--
ALTER TABLE `router_ipv4_blocks`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_ipv4_blocks` (`network`),
  ADD KEY `fk1_router_ipv4_blocks` (`geoFK`);

--
-- Index pour la table `router_ipv6_blocks`
--
ALTER TABLE `router_ipv6_blocks`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_ipv6_blocks` (`network`),
  ADD KEY `fk1_router_ipv6_blocks` (`geoFK`);

--
-- Index pour la table `router_locations`
--
ALTER TABLE `router_locations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_locations` (`continentCode`,`countryCode`);

--
-- Index pour la table `router_markdown`
--
ALTER TABLE `router_markdown`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_markdown` (`name`);

--
-- Index pour la table `router_monitoring`
--
ALTER TABLE `router_monitoring`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_monitoring` (`node`);

--
-- Index pour la table `router_role`
--
ALTER TABLE `router_role`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_role` (`role`);

--
-- Index pour la table `router_search_interface`
--
ALTER TABLE `router_search_interface`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_search_interface` (`group`,`name`);

--
-- Index pour la table `router_short_url`
--
ALTER TABLE `router_short_url`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_short_url` (`hash`);

--
-- Index pour la table `router_user`
--
ALTER TABLE `router_user`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_user` (`AMIUser`);

--
-- Index pour la table `router_user_role`
--
ALTER TABLE `router_user_role`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk1_router_user_role` (`userFK`,`roleFK`),
  ADD KEY `fk2_router_user_role` (`roleFK`);
...
--
-- AUTO_INCREMENT pour la table `router_authority`
--
ALTER TABLE `router_authority`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_catalog`
--
ALTER TABLE `router_catalog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_command`
--
ALTER TABLE `router_command`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_command_role`
--
ALTER TABLE `router_command_role`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_config`
--
ALTER TABLE `router_config`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_converter`
--
ALTER TABLE `router_converter`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_dashboard`
--
ALTER TABLE `router_dashboard`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_entity`
--
ALTER TABLE `router_entity`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_field`
--
ALTER TABLE `router_field`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_foreign_key`
--
ALTER TABLE `router_foreign_key`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_ipv4_blocks`
--
ALTER TABLE `router_ipv4_blocks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_ipv6_blocks`
--
ALTER TABLE `router_ipv6_blocks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_locations`
--
ALTER TABLE `router_locations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_markdown`
--
ALTER TABLE `router_markdown`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_monitoring`
--
ALTER TABLE `router_monitoring`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_role`
--
ALTER TABLE `router_role`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `router_search_interface`
--
ALTER TABLE `router_search_interface`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `router_user_role`
--
ALTER TABLE `router_user_role`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Contraintes pour la table `router_command_role`
--
ALTER TABLE `router_command_role`
...
--
-- Contraintes pour la table `router_ipv4_blocks`
--
ALTER TABLE `router_ipv4_blocks`
...
--
-- Contraintes pour la table `router_ipv6_blocks`
--
ALTER TABLE `router_ipv6_blocks`
...
--
-- Contraintes pour la table `router_user_role`
--
ALTER TABLE `router_user_role`
...
--
CREATE DATABASE IF NOT EXISTS `task` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci;
USE task;
...
CREATE TABLE `router_task` (
  ...
  `lastStartDate` int(11) NOT NULL DEFAULT 0,
  `lastStopDate` int(11) NOT NULL DEFAULT 0
) ;
...
(24, 'recurent-task-1', 'example of recurent task', 'echo \"Hello World! I am recurent-task-1\"', '', 0, 0, 0, 10, 'DEMO', 0, 1, '{}', 'Hello World! I am recurent-task-1\n', '@EMPTY', 1723109611, 1723109612);
...
--
-- Index pour la table `router_task`
--
...
--
-- AUTO_INCREMENT pour la table `router_task`
--
ALTER TABLE `router_task`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
